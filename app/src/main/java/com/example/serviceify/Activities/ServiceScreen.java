...
public class ServiceScreen extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        intent=getIntent();
        serviceModel= (ServiceModel) intent.getSerializableExtra("model_class");
        ...
        title=findViewById(R.id.service_screen_title);
        address=findViewById(R.id.service_screen_address);
        price=findViewById(R.id.service_screen_service_cost);

        address.setText(serviceModel.getAddress());
